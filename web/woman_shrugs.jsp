 	...
 	<div class="container">
 		<div class="row">
 				...
 				<div class="col-md-8"><!-- right -->
 					<h2 style="text-align: center;">Woman Shrugs</h2><br>
					...
					<input type="hidden" name="action" value="woman_shrugs">
					<select name="sort">
					...
					<input type="submit" value="Go!">
 					...
 					<c:forEach items="${list }" var="product">
 						...
 						<c:if test="${product.getCategory() == 'w_sh' }">
		 					...
		 					<div class="col-md-4">
								...
								<div class="text-center">  <a class="btn btn-primary" href="Controller?page=addtocart&action=woman_shrugs&id=<c:out value="${product.getId()}"/>">Add to Cart</a> </div><br>		 					</div>
