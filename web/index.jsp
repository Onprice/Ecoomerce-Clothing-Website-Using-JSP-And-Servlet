			...
			<nav class="navbar navbar-default">
				...
				<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
					<ul class="nav navbar-nav">
						<li class="active"><a href="index.json" class="act">Home</a></li>	
						<!-- Mega Menu -->
						<li class="dropdown">
 	...
 	<div class="container">
 		<div class="row">
 				...
 				<div class="col-md-8"><!-- right -->
                                    <h2 style="text-align: center; padding-botton:70px">Featured Products</h2><hr><br>
 	<c:forEach items="${list }" var="product">
 						...
 						<c:if test="${product.getFeatured() == 'yes' }">
		 					...
		 					<div class="col-md-4">
		 						...
		 						<p style="text-align: center;" class="item_price"> $  <c:out value="${ product.getPrice() }"></c:out></p>
