...
<div class="header">
	...
	<header><div class="navigation" style="margin-top:-15px">
		<div class="container">
 	...
 	<div class="container">
 		<div class="row">
 				...
 				<div class="col-md-8"><!-- right -->
					...
					<input type="hidden" name="action" value="woman_party">
					<select name="sort">
					...
					<input type="submit" value="Go!">
 					...
 					<c:forEach items="${list }" var="product">
 						...
 						<c:if test="${product.getCategory() == 'w_p' }">
		 					...
		 					<div class="col-md-4">
								...
								<div class="text-center">  <a class="btn btn-primary" href="Controller?page=addtocart&action=woman_party&id=<c:out value="${product.getId()}"/>">Add to Cart</a> </div><br>		 					</div>
