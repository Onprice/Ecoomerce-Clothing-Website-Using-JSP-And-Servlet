...
<body>
	<header  style="background-color:#2D5296">
		<h1>
			Welcome admin
		</h1>
		<nav>
	...
	<div class="signup-header"  style="background-color:#2D5296">
	 	<h2  style="background-color:#2D5296">Add Product</h2>
	 </div>
	 ...
	 <input type="hidden" name="page" value="add_product">
	 	...
	 	<div class="signup-group" style="margin-bottom:50px">
			<input type="submit" value="Process"  style="background-color:#2D5296;color:white">	 
		</div>
	 </form>
