 	...
 	<div class="container">
 		<div class="row">
 				...
 				<div class="col-md-8"><!-- right -->
 					<h2 style="text-align: center;">Men's Casual Wear</h2><br>
					...
					<input type="hidden" name="action" value="mens_jeans">
					<select name="sort">
					...
					<input type="submit" value="Go!">
 					...
 					<c:forEach items="${list }" var="product">
 						...
 						<c:if test="${product.getCategory() == 'm_j' }">
		 					...
		 					<div class="col-md-4">
								...
								<div class="text-center">  <a class="btn btn-primary" href="Controller?page=addtocart&action=mens_jeans&id=<c:out value="${product.getId()}"/>">Add to Cart</a> </div><br>		 					</div>
